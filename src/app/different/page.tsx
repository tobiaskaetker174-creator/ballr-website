...
export const metadata: Metadata = {
  title: "What Makes BallR Different â BallR",
  description:
...
const problems = [
  ...
  },
  {
    ...
    details:
      "Every player has a public reliability score (0â100%). Miss a game without notice? Your score drops, you lose 50 ELO, and everyone can see it. Chronic no-shows get flagged. It's like a credit score, but for keeping your word about Tuesday football.",
  },
  {
  ...
  },
  {
    ...
    details:
      "Pick a venue, set the time, choose the skill level, set the price â done. Players find your game in the Discover feed, pay online, and show up. No more chasing payments or counting heads in a group chat at 5pm.",
  },
];
