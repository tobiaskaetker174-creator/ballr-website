        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a href="#" className="bg-primary hover:bg-primary-dark text-text font-bold px-8 py-3 rounded-xl transition-all hover:scale-105 inline-flex items-center justify-center gap-2">
