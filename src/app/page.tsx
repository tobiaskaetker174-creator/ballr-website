...
const LiveGameFeed = dynamic(() => import("@/components/LiveGameFeed"), {
  loading: () => <div className="h-64 bg-surface/50 animate-pulse rounded-2xl" />,
});
const PlayerSpotlightCarousel = dynamic(() => import("@/components/PlayerSpotlightCarousel"), {
  loading: () => <div className="h-96 bg-surface/50 animate-pulse rounded-2xl" />,
});
...
export default function HomePage() {
  return (
    <>
      ...
      {/* Live Game Feed — Countdown Timers */}
      <LiveGameFeed />
      ...
      {/* 🏅 Player Spotlight Carousel — Auto-rotating */}
